...
- 読み込みの指定: `src/styles/global.css` の `@font-face`

## woff2 の作り直し

```bash
pip install fonttools brotli
python -c "from fontTools.ttLib import TTFont; f=TTFont('design-src/fonts/MadouFutoMaruGothic.ttf'); f.flavor='woff2'; f.save('public/fonts/MadouFutoMaruGothic.woff2')"
```
